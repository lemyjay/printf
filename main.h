 ...
 *
 * @fmt: format for the struct
 * @fn: function associated with the struct.
 */
struct fmt
{
	char fmt;
...
/** PROTOTYPES USED FOR TASK **/

/* For characters and string */
...
/*Function to print string in reverse and rot 13 */
